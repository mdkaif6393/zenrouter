...
- [Imperative Navigation Guide](../paradigms/imperative.md) - Using DynamicNavigationPath
- [Declarative Navigation Guide](../paradigms/declarative.md) - Using NavigationStack.declarative
- [Coordinator Pattern Guide](../paradigms/coordinator.md) - Using paths with Coordinator
- [Route Mixins](mixins.md) - Adding behavior to routes
